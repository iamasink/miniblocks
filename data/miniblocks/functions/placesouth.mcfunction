...
execute as @e[type=minecraft:block_display,limit=1,sort=nearest] at @s if entity @s[nbt={block_state:{Name:"minecraft:lightning_rod"}}] run data modify entity @s block_state.Properties.facing set value south
