...
# summon the 6 interactions for placing blocks (any of them can be hit to break it)
 execute positioned ~0.001 ~ ~ run summon interaction ~0.03125 ~ ~0.03125 {width:0.0625f,height:0.0625f,response:0b,Tags:["miniblocks.eastinteraction","miniblocks.interaction"],attack:{timestamp:-1},interaction:{timestamp:-1}}
execute positioned ~-0.001 ~ ~ run summon interaction ~0.03125 ~ ~0.03125 {width:0.0625f,height:0.0625f,response:0b,Tags:["miniblocks.westinteraction","miniblocks.interaction"],attack:{timestamp:-1},interaction:{timestamp:-1}}
 execute positioned ~ ~ ~0.001 run summon interaction ~0.03125 ~ ~0.03125 {width:0.0625f,height:0.0625f,response:0b,Tags:["miniblocks.southinteraction","miniblocks.interaction"],attack:{timestamp:-1},interaction:{timestamp:-1}}
execute positioned ~ ~ ~-0.001 run summon interaction ~0.03125 ~ ~0.03125 {width:0.0625f,height:0.0625f,response:0b,Tags:["miniblocks.northinteraction","miniblocks.interaction"],attack:{timestamp:-1},interaction:{timestamp:-1}}
 execute positioned ~ ~0.001 ~ run summon interaction ~0.03125 ~ ~0.03125 {width:0.0625f,height:0.0625f,response:0b,Tags:["miniblocks.upinteraction","miniblocks.interaction"],attack:{timestamp:-1},interaction:{timestamp:-1}}
execute positioned ~ ~-0.001 ~ run summon interaction ~0.03125 ~ ~0.03125 {width:0.0625f,height:0.0625f,response:0b,Tags:["miniblocks.downinteraction","miniblocks.interaction"],attack:{timestamp:-1},interaction:{timestamp:-1}}
